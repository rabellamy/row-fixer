...
1 - This works for multiple selectors inside a container. Setting the max height to just one selector (like a title) is simple. Handling multiple selectors is a little bit trickier.
